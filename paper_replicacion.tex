...
\todo{Aquí me gustaría que explicaras muy brevemente qué es la distribución de Haar, cómo se llevó a cabo la implementación de esta estrategia (toca checar los informes_tecnicos y la presentacion_replicacion}
...
\todo{modifica para que se vea bien solo esta figura}
\begin{figure}[H]
    \centering
...
forward-looking destacado por \citet{eichenbaum1992} y \citet{hanson2004}. \todo{por favor, reescribe este párrafo, sé más conciso}
